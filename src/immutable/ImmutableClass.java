...
public class ImmutableClass {
	...
	public static void main(String[] args) {
		...
		subClassofimmutableClass ce = new subClassofimmutableClass(i, s, h1);
		...
		System.out
				.println("ce testMap after changing variable from accessor methods:"
						+ ce.getTestMap());
...
class subClassofimmutableClass extends ImmutableClass{

	public subClassofimmutableClass(int i, String n, HashMap<String, String> hm) {
		super(i, n, hm);
			}
